...
public class ThreadFirstTrain extends Thread {
  ...
  public void run(int pos) {
    ...
    if (pos == 1) {
      ...
      translate01.setNode(mainController.getTrain1());
      ...
      translate02.setNode(mainController.getTrain1());
      ...
      translate03.setNode(mainController.getTrain1());
      ...
      translate04.setNode(mainController.getTrain1());
      ...
      translate05.setNode(mainController.getTrain1());
      ...
      translate06.setNode(mainController.getTrain1());
      ...
      translate07.setNode(mainController.getTrain1());
      ...
      translate08.setNode(mainController.getTrain1());
      translate08.setDuration(Duration.millis(time));
      translate08.setByX(110);
      translate08.setByY(-30);
      SequentialTransition st = new SequentialTransition(translate01, translate02, translate03, translate04, translate05, translate06, translate07, translate08);
      st.play();
    } else if (pos == 2) {
      TranslateTransition translate01 = new TranslateTransition();
      mainController.setTrainImg("/assets/train.png", 1);
